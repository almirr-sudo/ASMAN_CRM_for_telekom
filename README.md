# ASMAN CRM — система для операторов связи Кыргызстана

ASMAN CRM помогает кыргызстанским телеком-провайдерам управлять абонентами, SIM-картами, тарифами, договорами и платежами в единой платформе.

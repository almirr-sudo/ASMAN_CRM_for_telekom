...
urlpatterns = [
    ...
    path('tickets/notifications/', login_required(ticket_notifications), name='ticket_notifications'),
    path('ws/tickets/', websocket_placeholder, name='ws_ticket_placeholder'),
]
